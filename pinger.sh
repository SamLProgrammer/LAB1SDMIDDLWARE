...
echo "$last_debian0_ping $current_date" > /home/debian2/last_debian0_ping.txt
echo "$last_debian1_ping $current_date" > /home/debian2/last_debian1_ping.txt
echo "$history_debian0_ping $current_date" >> /home/debian2/history_debian0_ping.txt
echo "$history_debian1_ping $current_date" >> /home/debian2/history_debian1_ping.txt
